 ...
 *  /searchPurse 查询钱包
 *  /getPurse  查看钱包
 *  /updatePursePass 钱包充值通过
 *  /updatePurseRefuse 不通过
 *  /updatePurseState 用户查看审核结果
 */



import com.tjpu.pojo.*;
import com.tjpu.service.*;
import com.tjpu.service.impl.NoticeServiceImpl;
import com.tjpu.util.GoodsGrid;
import com.tjpu.util.OrdersGrid;
import com.tjpu.util.PurseGrid;
import com.tjpu.util.UserGrid;
...
//		int userid = noticeService.getUserIdByNoticeId(Integer.parseInt(id));
		//做了修改  之前是userid
