        ...
        <form class="form-horizontal" id="myserchform" name="myform" action="<%=basePath%>admin/searchGoods"
            ...
            <div class="form-group">
                <div class="col-lg-8" style="text-align:center;">
                    ...
                    <span>状态：</span>
                    <select name="status" data-style="btn-info"   id="myselected">
            ...
            <div class="modal-body" style="height:0 auto; ">
                <form class="form-horizontal" id="myeditform" name="myform">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="my_catelogId" name="catelogId"
            ...
            <div class="modal-body" style="height:0 auto; ">
                <form class="form-horizontal" id="myviewform" name="myform">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 control-label">状态:</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="my_form" name="status" readonly
                                   style="margin-top: 8px;"/>
                        </div>
                    </div>
                </form>
