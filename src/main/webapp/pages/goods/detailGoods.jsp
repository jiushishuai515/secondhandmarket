    ...
    <div id="login-show" class="login stark-components">
        <div class="publish-box z-depth-4">
            <div class="row">
                ...
                <form action="<%=basePath%>user/login" method="post" modelAttibute="user" role="form">
    ...
    <div id="signup-show" class="signup stark-components">
        <div class="publish-box z-depth-4">
            <div class="row">
                ...
                <form:form action="../../user/addUser" method="post" modelAttribute="user" role="form">
                    <div class="input-field col s12">
    ...
    <div id="changeName" class="change-name stark-components">
        <div class="publish-box z-depth-4">
            <div class="row">
                ...
                <form:form action="../../user/changeName" method="post" modelAttribute="user" role="form">
                    <div class="input-field col s12">
                        <input type="text" name="username" required="required" class="validate ng-pristine ng-empty ng-invalid ng-invalid-required ng-valid-pattern ng-touched" />
                        <label>修改用户名</label>
                    </div>
...
<div ng-controller="detailBoxController" class="detail-box stark-components z-depth-1 row ng-scope">
    ...
    <div class="col s6">
        ...
        <div class="item-public-info">
            ...
            <p>
                <i class="iconfont"></i>
                <em class="item-location">天津工业大学</em>
            </p>
        </div>
