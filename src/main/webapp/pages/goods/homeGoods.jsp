        ...
        <div class="publish-box z-depth-4">
            <div class="row">
                ...
                <form action="<%=basePath%>user/login" method="post" role="form">
                    <div class="input-field col s12">                                         <%--输入格式--%>
...
<div ng-controller="sidebarController" class="sidebar stark-components ng-scope">
    ...
    <div class="info">
        <a href="https://github.com/jiushishuai515" target="_blank">关于我们</a><em>-</em>
        <a href="">联系我们</a>
        <p>©2019 天工大二手工坊</p>
    </div>
</div>
                    ...
                    <a href="<%=basePath%>goods/homeGoods">
                        <div class="bannerimg">
                            <ul class="bannerul">
                                ...
                                <p class="text2">欢迎来到天津工业大学secondHandMarket校园二手工坊。临近毕业季的</p>
                                <p class="text3">你，是否有太多的闲置与校友分享，为了追求更好的校园服</p>
                                <p class="text4">务，我们打造了一个全新的校园平台——<span>天工大二手工坊</span></p>
                                <p class="text5">这里有更多的闲置分享，更自由的校园话题讨论，你想要的，都在这里。</p>
                                <p class="text6">加入TGD-SecondHandMarket，你的大学，应更精彩。</p>
                            </ul>
                        </div>
                    </a>
                </li>
