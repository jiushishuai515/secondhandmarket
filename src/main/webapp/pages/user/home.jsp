                    ...
                    <c:if test="${notice!=null}">
                        <div class="yes_share">
                            ...
                            <c:forEach items="${notice}" var="item" varStatus="status">
                                <button type="button" class="btn btn-default" onclick="viewPersonal(${item.user.id})"
                                        style="background-color: #c6f5f4;border:0px;outline:none;">${item.user.username}</button>
